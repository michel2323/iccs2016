...
\begin{figure}
  ...
  \subfigure[Flow in a straight pipe at $Re=1000$]{\includegraphics[width=0.45\textwidth]{./figures/nek_2.png}}
\end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    %time step have the same runtime. The seeming discontinuity in the
...
\begin{figure}
  \centering
  \subfigure[Adjoint]{\includegraphics[width=0.45\textwidth]{./figures/grad_adj.png}}
  \subfigure[Finite difference]{\includegraphics[width=0.45\textwidth]{./figures/grad_fd_rescale.png}}
...
\begin{frame}
  ...
  \begin{center}
    \begin{tabular}{cc}
      ...
      %\movie[poster,width=4cm, height=3cm,showcontrols]{}{./videos/primal.mpg}
      &
      %\movie[poster,width=4cm,height=3cm,showcontrols]{}{./videos/dual_nonlinear_adj_4000.mpg}
      \\
    \end{tabular}
  \end{center}
\end{frame}
